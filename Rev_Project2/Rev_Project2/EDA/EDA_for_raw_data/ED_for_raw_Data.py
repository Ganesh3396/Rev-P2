...
def plot_quantity_distribution(df):
    ...
    plt.figure(figsize=(# In the functions `plot_payment_type_distribution`,
    # `plot_price_distribution`, `plot_quantity_distribution`,
    # `plot_payment_success_distribution`, and `plot_failure_reason_distribution`,
    # the parameters `8, 4` inside the `plt.figure(figsize=(8, 4))` function call
    # specify the width and height of the figure in inches for the respective
    # plots.
    8, 4))
...
if __name__ == "__main__":
    # Load data
    file_path = r"D:\Rev_Project2\Rev_Project2\Generator\ecommerce_raw_data.csv"
